...
export default class ShopSettingScreen extends React.Component {
    constructor(props){
        ...
        this.state = {
            ...
            checkedVISA: true,checkedAme: true,
            checkedJCB: false,checkedMas: true,checkedUni: false,
        }
    }
    ...
    render() {
        ...
        <Card
            ...
            <TextField
                ...
                placeholder='เที่ยวก่อน จ่ายทีหลัง แบ่งจ่ายเบาๆ 0% นาน 4 เดือน'
            ...
            <TextField
                ...
                placeholder='เงื่อนไข -รับสิทธิ์แบ่งจ่ายนาน 4 เดือน สำหรับยอดใช้จ่ายตั้งแต่ 4,000 บาทขึ้นไป/เซลล์สลิป -สิทธิพิเศษดังกล่าวเฉพาะผู้ถือบัตรเครดิตกสิกรไทยเท่านั้น'
                multiline={true}
                numberOfLines={10}
            />
